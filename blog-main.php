...
<div class="page-container">
  ...
  <div class="columns">
    <div class="column">
      <div class="card" id="single-post-card">
    ...
    <div class="column">
      <div class="card">
        <div class="card-image">
          <figure class="image is-4by3">
            <img src="<?php echo get_template_directory_uri() . '/img/story-two.jpg';?>" alt="Placeholder image">
          </figure>
        </div>
        <div class="card-content">
          <div class="content">
    ...
    <div class="column">
      <div class="card">
        <div class="card-image">
          <figure class="image is-4by3">
            <img src="<?php echo get_template_directory_uri() . '/img/story-three.jpg';?>" alt="Placeholder image">
          </figure>
        </div>
        <div class="card-content">
          <div class="content">
